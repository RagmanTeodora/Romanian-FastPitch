...
#from fastpitch.model_encoder import FastPitch
from fastpitch.model_jit import FastPitchJIT
from hifigan.models import Generator


#### importing FastPitch depending on the chosen configuration:
import importlib, os

config_choice = os.getenv('FASTPITCH_config')
fpitch_module = f"model_{config_choice}"
if not fpitch_module:
    raise ValueError("FASTPITCH_config environment variable is not set or is empty.")
else:
    print(f"From models.py: Importing model: {fpitch_module}")

spec = importlib.util.spec_from_file_location(fpitch_module, f"fastpitch/{fpitch_module}.py")
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)
FastPitch = getattr(module, 'FastPitch', None) #from fastpitch.model_decoder import FastPitch
print(FastPitch)
####
